...
img.onload = function () {
    ...
    if (screen.width < 500) {
        ...
        if (img.height == 1920) {
            ...
            ratio = (screen.width - 60) / img.width;
        }//Telas médias
...
function resetSliders(){
    let saturation = $("#saturation").data("ionRangeSlider");  
    saturation.update({from: 0});
    let hue = $("#hue").data("ionRangeSlider");  
    hue.update({from: 0});
    let luminance = $("#luminance").data("ionRangeSlider");  
    luminance.update({from: 0});
