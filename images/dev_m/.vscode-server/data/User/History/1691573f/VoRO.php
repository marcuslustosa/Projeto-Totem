                ...
                <form class="form theme-form mega-form" method="post"
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-3 col-12 text-center">
                            @if(is_null($template->small_thumb))
                                <img src="{{s3Image($template->image)}}" alt="thumb" id="thumb" class="post-template-thumb">
                            @else 
                                <img src="{{s3Image($template->medium_thumb)}}" alt="thumb" id="thumb" class="post-template-thumb">
                            @endif
