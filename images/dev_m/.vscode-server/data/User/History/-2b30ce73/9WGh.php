        ...
        <form method="POST" action="{{ route('subscription') }}" enctype="multipart/form-data">
            ...
            <div class="mt-4 col-12">
                <div>
                    ...
                    <x-input id="cnpj" class="block mt-1 w-50" type="text" name="cnpj" :value="old('cnpj')" required />
                </div>
                <div>
                    <x-label for="trade-name" value="Razão Social" />
                    <x-input id="trade_name" class="block mt-1 w-50" type="text" name="trade_name" :value="old('trade_name')" required />
                </div>
            </div>    
