                ...
                <form class="form theme-form mega-form" method="post" action="{{ route('leads.store') }}">
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-4 col-12">
                            <label class="col-form-label" for="gender">Origem do Lead</label>
                            <select class="form-select input-air-primary digits" id="origin" name="origin">
                                @foreach(campaignOrigins() as $id => $origin)
                                <option value="{{$id}}">{{$origin['name']}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3 col-lg-4 col-12">
                            <label class="col-form-label" for="gender">Status</label>
                            <select class="form-select input-air-primary digits" id="status" name="status">
                                @foreach(leadStatus() as $id => $status)
                        ...
                        <div class="mb-3 col-lg-4 col-12">
                            <label class="col-form-label">Primeiro Contato</label>

                            <input class="datepicker-here form-control digits" type="text" data-language="pt" id="birth" name="birth" value="{{Carbon\Carbon::today()->format('d/m/Y')}}">
                        </div>
                    </div>
					...
					<div class="mb-3">
						...
						<input class="form-control" type="text" placeholder="Rua">
					</div>
					<div class="mb-3">
						<label class="col-form-label">z</label>
						<input class="form-control" type="text" placeholder="z">
					</div>
					-->
                    <hr class="mt-4 mb-4">
                    <div class="float-end">
