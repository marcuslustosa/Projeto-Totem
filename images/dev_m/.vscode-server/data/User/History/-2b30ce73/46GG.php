    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('subscription') }}" enctype="multipart/form-data">
            ...
            <div class="mt-4 col-6">
                ...
                <x-input id="cnpj" class="block mt-1 col-6" type="text" name="cnpj" :value="old('cnpj')" required />
            </div>
            <div class="mt-4">
                <div>
                    <x-label for="trade-name" value="Razão Social" />
                    <x-input id="trade_name" class="block mt-1 col-6" type="text" name="trade_name" :value="old('trade_name')" required />
                </div>
                <div>
                    <x-label for="phone" value="Telefone" />
                    <x-input id="phone" class="block mt-1 col-6" type="text" name="phone" :value="old('phone')" required />
                </div>
            </div>
            <div class="mt-4">
