                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row col-12">
                                ...
                                <div class="col-12 m-l-1 justify-content-center">                                        
                                    
                                    <div class="collapse col-12 justify-content-center" id="collapseicon" aria-labelledby="collapseicon" data-bs-parent="#accordion">
                                        ...
                                        <div class="mb-1 col-12 row align-items-end">
                                            ...
                                            <div class="col-4">                                            
                                                <button class="btn btn-primary btn-sm p-1" onclick="resetSliders()" type="button">
                                                    Limpar Filtros 
                                                </button>
                                            </div>    
                                        </div>
