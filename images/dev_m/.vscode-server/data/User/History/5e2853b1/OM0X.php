            ...
            <div class="card">
                ...
                <div class="card-body photoswipe-pb-responsive">
                    <div class="my-gallery row grid gallery" style="min-height: 10rem;" id="myGallery">
                        ...
                        <figure class="col-xl-2 col-md-2 col-sm-4 col-4 grid-item" onclick="setImage('/s3?path={{$template->image}}', '{{$template->x_position}}', '{{$template->y_position}}', '{{$template->logo_width}}', '{{$template->logo_height}}', '{{$template->logo_color}}', '{{$template->name}}' , '{{$template->description}}')">

                            <a href="#">
                                <div class="product-box">
                                    <div class="product-img">
                                        @if($template->small_thumb == "")
                                        <img class="img-fluid w-100" src="/s3?path={{$template->image}}" alt="">
                                        @else 
                                        <img class="img-fluid w-100" src="/s3?path={{$template->small_thumb}}" alt="">
                                        @endif
