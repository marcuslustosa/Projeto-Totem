...
<div class="container-fluid">
    <div class="col-12 row justify-content-end p-r-5 d-none">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body photoswipe-pb-responsive">
                    <div class="my-gallery row grid gallery" style="min-height: 10rem;" id="myGallery">
                        ...
                        <figure class="col-xl-3 col-md-3 col-sm-6 col-6 grid-item" onclick="setImage('/s3?path={{$template->image}}', '{{$template->x_position}}', '{{$template->y_position}}', '{{$template->logo_width}}', '{{$template->logo_height}}', '{{$template->logo_color}}', '{{$template->name}}' , '{{$template->description}}')">

                            <a href="#">
                                <div class="product-box">
                                    <div class="product-img">
                                        @if($template->medium_thumb == "")
                                        <img class="img-fluid w-100" src="/s3?path={{$template->image}}" alt="">
                                        @else 
                                        <img class="img-fluid w-100" src="/s3?path={{$template->medium_thumb}}" alt="">
                                        @endif
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="row">
                                <h4 class="modal-title d-none" id="post-title"></h4>
                        ...
                        <div class="modal-body">
                            <div class="row mx-0">
                                ...
                                <div class="collapse px-0 px-md-4" id="collapseicon" aria-labelledby="collapseicon" data-bs-parent="#accordion">
                                    ...
                                    <div class="my-1 py-1 row align-items-end">

                                        <div class="col-6">
                                            <!-- <label class="col-form-label-sm pb-0 mb-0" for="type">Versão do Logo</label> -->
                                            <select class="form-select input-air-primary digits form-control form-control-sm" id="logo-color" name="type">
                                            
                                                <option value="0">Logo Colorido</option>
                                                <option value="1">Logo Claro</option>
                                                <option value="2">Logo Escuro</option>
                                            
                                            </select>
                                        </div>
                                        <div class="col-6">                                            
                                            <button class="btn btn-light btn-sm py-2 w-100" onclick="resetSliders()" type="button">
                                                Limpar Filtros 
                                            </button>
                                        </div>    
                                    </div>
