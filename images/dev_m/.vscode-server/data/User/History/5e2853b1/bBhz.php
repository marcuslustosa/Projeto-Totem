                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row col-12">
                                ...
                                <div class="w-100 d-flex d-flex justify-content-center align-items-center">                                        
                                    ...
                                    <div class="collapse" id="collapseicon" aria-labelledby="collapseicon" data-bs-parent="#accordion">
                                        ...
                                        <div class="mb-2 col-12 row d-flex d-flex justify-content-center align-items-end">
                                            ...
                                            <div class="col-6">                                            
                                                <button class="btn btn-primary btn-sm" onclick="resetSliders()" type="button">
                                                    Limpar Filtros 
                                                </button>
                                            </div>    
                                        </div>
