...
class PostGalleryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('type')) {
            ...
            if ($request->type == 0) {
                ...
                $title = "Imasadasdasdasgens para Story";
            }
    ...
    public function postByType(Request $request, string $type)
    {
        ...
        $templates = Template::where('type', $postTypeID)->orderBy('updated_at', 'desc')->paginate(10);
    ...
    public function filter(Request $request)
    {
        ...
        if ($request->has('type')) {
            ...
            $templates = $templates->orderBy('updated_at', 'desc')->paginate(1);
        } else {
            $templates = Template::orderBy('updated_at', 'desc')->paginate(1);
        }
