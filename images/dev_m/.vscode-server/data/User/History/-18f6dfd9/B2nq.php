...
class PostGalleryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('type')) {
            ...
            $templates = $templates->orderBy('created_at', 'desc')->paginate(8);
        } else {
            $templates = Template::orderBy('created_at', 'desc')->paginate(8);
        }
    ...
    public function postByType(Request $request, string $type)
    {
        ...
        $templates = Template::where('type', $postTypeID)->orderBy('created_at', 'desc')->paginate(8);
