        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('studios.lead')}}" method="post">
                    ...
                    <input type="hidden" id="user_whatsapp" name="user_whatsapp" value="{{$studio->whatsapp}}">
                    <input type="hidden" id="user_phone" name="user_phone" value="{{$studio->phone}}">
            ...
            <div class="modal-footer">
                ...
                <a href="#" class="btn btn-b" onclick="submitWhatsAppForm()"
