...
class TemplateController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->file('image')) {
            ...
            $mediumthumbnail = 'medium_' .$filename;
            //Upload local File
            $request->file('image')->storeAs("public/resizing/", $filename, "public");
            $request->file('image')->storeAs("public/resizing/", $smallthumbnail, "public");
            $request->file('image')->storeAs("public/resizing/", $mediumthumbnail, "public");                        
            
            $local_image = public_path("public/resizing/".$filename);
