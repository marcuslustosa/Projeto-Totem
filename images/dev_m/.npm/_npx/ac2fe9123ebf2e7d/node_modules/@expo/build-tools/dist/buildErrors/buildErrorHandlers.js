...
exports.buildErrorHandlers = [
    ...
    })),
    {
        platform: eas_build_job_1.Platform.IOS,
        phase: eas_build_job_1.BuildPhase.INSTALL_PODS,
        regexp: ({ env }) => env.EAS_BUILD_COCOAPODS_CACHE_URL ? /Error installing/ : undefined,
        createError: () => new TrackedBuildError('COCOAPODS_CACHE_INSTALLING_POD_ERROR', `cocoapods: error installing a pod using internal cache instance`),
    },
    {
        platform: eas_build_job_1.Platform.IOS,
        phase: eas_build_job_1.BuildPhase.INSTALL_PODS,
        regexp: ({ env }) => env.EAS_BUILD_COCOAPODS_CACHE_URL ? /No podspec exists at path/ : undefined,
        createError: () => new TrackedBuildError('COCOAPODS_CACHE_NO_PODSPEC_EXISTS_AT_PATH_ERROR', `cocoapods: error fetching a podspec through internal cache instance`),
    },
    {
        platform: eas_build_job_1.Platform.IOS,
        phase: eas_build_job_1.BuildPhase.INSTALL_PODS,
    ...
    },
    {
        ...
        createError: () => new TrackedBuildError('REQUIRE_EXPLICIT_EXPORTED_ANDROID_12', 'Apps targeting Android 12 and higher are required to specify an explicit value for `android:exported`.'),
    },
    {
        phase: eas_build_job_1.BuildPhase.RUN_GRADLEW,
        platform: eas_build_job_1.Platform.ANDROID,
    ...
    },
    {
        ...
        createError: () => new TrackedBuildError('GRADLE_MALFORMED_GOOGLE_SERVICES_JSON', 'gradle: Missing project_info object.'),
    },
    {
        phase: eas_build_job_1.BuildPhase.RUN_GRADLEW,
        platform: eas_build_job_1.Platform.ANDROID,
    ...
    },
    {
        ...
        createError: () => new TrackedBuildError('MAVEN_REGISTRY_CONNECTION_ERROR', `maven: registry connection error`),
    },
    {
        platform: eas_build_job_1.Platform.ANDROID,
        phase: eas_build_job_1.BuildPhase.RUN_GRADLEW,
    ...
    },
    {
        ...
        createError: () => new TrackedBuildError('FLIPPER_FOLLY_COMPILE_ERROR', 'fastlane: Flipper-Folly compile error.'),
    },
    {
        phase: eas_build_job_1.BuildPhase.RUN_FASTLANE,
        platform: eas_build_job_1.Platform.IOS,
